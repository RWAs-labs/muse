// Package metrics provides metrics functionalities for the museclient
package metrics
...
// MuseClientNamespace is the namespace for the metrics
const MuseClientNamespace = "museclient"
...
var (
	...
	// block time from musecore
	CoreBlockLatency = promauto.NewGauge(prometheus.GaugeOpts{
		Namespace: MuseClientNamespace,
		Name:      "core_block_latency",
		Help:      "Difference between system time and block time from musecore",
	})
	...
	// Info is a gauge that contains information about the museclient environment
	Info = promauto.NewGaugeVec(prometheus.GaugeOpts{
		Namespace: MuseClientNamespace,
		Name:      "info",
		Help:      "Information about Museclient environment",
	}, []string{"version"})
