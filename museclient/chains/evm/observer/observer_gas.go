...
func (ob *Observer) PostGasPrice(ctx context.Context) error {
	...
	// The museclients now only build legacy tx rather than EIP-1559 tx.
	// Hardcode priority fee to zero to avoid gas price bump failure in the musecore:
	// https://github.com/RWAs-labs/muse/blob/release%2Fv30/x/crosschain/keeper/abci.go#L182
