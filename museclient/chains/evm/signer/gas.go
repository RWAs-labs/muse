...
//
//nolint:unused // https://github.com/RWAs-labs/muse/issues/3221
...
func gasFromCCTX(cctx *types.CrossChainTx, logger zerolog.Logger) (Gas, error) {
	...
	if limit > maxGasLimit {
		...
		// https://github.com/RWAs-labs/muse/issues/3725
	...
	case gasPrice.Cmp(priorityFee) == -1:
		...
		// this should in theory never happen, but this reported bug might be a cause: https://github.com/RWAs-labs/muse/issues/2954
