...
import (
	...
	ethclient "github.com/RWAs-labs/muse/museclient/chains/evm/client"
	keyinterfaces "github.com/RWAs-labs/muse/museclient/keys/interfaces"
	"github.com/RWAs-labs/muse/museclient/tss"
...
// MusecoreClient is the client interface to interact with musecore
//
//go:generate mockery --name MusecoreClient --filename musecore_client.go --case underscore --output ../../testutils/mocks
type MusecoreClient interface {
	MusecoreVoter
	...
	GetMuseHotKeyBalance(ctx context.Context) (sdkmath.Int, error)
...
// TODO https://github.com/RWAs-labs/muse/issues/3107
//
