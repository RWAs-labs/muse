...
import (
	...
	btccommon "github.com/RWAs-labs/muse/museclient/chains/bitcoin/common"
...
func Run_PendingMempoolTx(t *testing.T) {
	...
	// otherwise, museclient should not rely on these information to schedule RBF/CPFP transactions.
