...
const (
	...
	// The musecore bumps CCTX's fee rate every 40 minutes, and we can't wait that long in the E2E test.
	// For simplicity, museclient uses a constant fee rate (> above 1 sat/vB) to test RBF in the regnet.
	FeeRateRegnetRBF = 5
