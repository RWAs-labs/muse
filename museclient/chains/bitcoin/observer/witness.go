...
func GetBtcEventWithWitness(
	...
	// 1. sender is empty, we don't know whom to refund if this tx gets reverted in musecore
	...
	// the error message will be forwarded to musecore to register a failed CCTX
