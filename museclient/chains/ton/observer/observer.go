...
// PostGasPrice fetches on-chain gas config and reports it to Musecore.
func (ob *Observer) PostGasPrice(ctx context.Context) error {
	...
	_, err = ob.MusecoreClient().PostVoteGasPrice(ctx, ob.Chain(), gasPrice, priorityFee, blockNum)
	if err != nil {
