...
import (
	...
	"cosmossdk.io/math"
	musetonconfig "github.com/RWAs-labs/muse/museclient/chains/ton/config"
...
func TestClient(t *testing.T) {
	...
	t.Run("GetGasConfig", func(t *testing.T) {
		// ACT #1
		gas, err := musetonconfig.FetchGasConfig(ctx, client)
		...
		// ACT #2
		gasPrice, err := musetonconfig.ParseGasPrice(gas)
