...
func (signer *Signer) TryProcessOutbound(
	...
	signer.broadcastOutbound(ctx, outbound, chainID, nonce, logger, musecoreClient)
}
...
func (signer *Signer) signTx(
	...
	tx, err := solana.NewTransaction(
		...
		// https://github.com/RWAs-labs/muse/issues/2599
		instructions,
...
func (signer *Signer) broadcastOutbound(
	...
	for i := 0; i < broadcastRetries; i++ {
		...
		signer.reportToOutboundTracker(ctx, musecoreClient, chainID, nonce, txSig, logger)
		break
	}
}
