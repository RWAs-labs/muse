...
const (
	...
	TSSPubKeyMainnet     = "musepub1addwnpepqtadxdyt037h86z60nl98t6zk56mw5zpnm79tsmvspln3hgt5phdc79kvfc"

	// TSSPubkeyAthens3 is the TSS public key in Athens3
	TSSPubkeyAthens3 = "musepub1addwnpepq28c57cvcs0a2htsem5zxr6qnlvq9mzhmm76z3jncsnzz32rclangr2g35p"

	// TSSAddressEVMAthens3 the EVM TSS address for test purposes
	// Note: public key is musepub1addwnpepq28c57cvcs0a2htsem5zxr6qnlvq9mzhmm76z3jncsnzz32rclangr2g35p
	...
	EventMuseSent      = "MuseSent"
	EventMuseReceived  = "MuseReceived"
	EventMuseReverted  = "MuseReverted"
...
var GatewayAddresses = map[int64]string{
	...
	chains.SolanaDevnet.ChainId:  "MUSEjseVjuFsxdRxo6MmTCvqFwb3ZHUx56Co3vCmGis",
	chains.SolanaMainnet.ChainId: "MUSEjseVjuFsxdRxo6MmTCvqFwb3ZHUx56Co3vCmGis",
