// Package maintenance provides maintenance functionalities for the museclient.
package maintenance
...
func NewTSSListener(client interfaces.MusecoreClient, logger zerolog.Logger) *TSSListener {
...
func (tl *TSSListener) waitForNewKeygen(ctx context.Context) error {
	...
	for {
		...
		case <-ticker.C:
			...
			// Most likely the museclient is waiting for the keygen block to arrive.
