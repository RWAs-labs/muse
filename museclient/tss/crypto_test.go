...
func TestPubKey(t *testing.T) {
	t.Run("Invalid", func(t *testing.T) {
		cases := []struct {
			...
			{"malformed bech32", "musepub1invalid", "decoding bech32 failed"},
		}
	...
	t.Run("Valid NewPubKeyFromBech32", func(t *testing.T) {
		// ARRANGE
		const sample = `musepub1addwnpepqtadxdyt037h86z60nl98t6zk56mw5zpnm79tsmvspln3hgt5phdc79kvfc`
	...
	t.Run("Valid NewPubKeyFromECDSAHexString", func(t *testing.T) {
		...
		assert.True(t, strings.HasPrefix(actual.Bech32String(), "musepub"))
