...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"muse-chain", "emissions", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ListPoolAddresses_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"muse-chain", "emissions", "list_addresses"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ShowAvailableEmissions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"muse-chain", "emissions", "show_available_emissions", "address"}, "", runtime.AssumeColonVerbOpt(false)))
)
