...
func TestDefaultAuthorizationsList(t *testing.T) {
	t.Run("default authorizations list", func(t *testing.T) {
		var OperationalPolicyMessageList = []string{
			...
			sdk.MsgTypeURL(&fungibletypes.MsgUpdateMRC20LiquidityCap{}),
			sdk.MsgTypeURL(&fungibletypes.MsgUpdateMRC20WithdrawFee{}),
			sdk.MsgTypeURL(&fungibletypes.MsgUnpauseMRC20{}),
		...
		var EmergencyPolicyMessageList = []string{
			...
			sdk.MsgTypeURL(&fungibletypes.MsgPauseMRC20{}),
		...
		var AdminPolicyMessageList = []string{
			...
			sdk.MsgTypeURL(&fungibletypes.MsgDeployFungibleCoinMRC20{}),
			...
			sdk.MsgTypeURL(&fungibletypes.MsgUpdateMRC20Name{}),
