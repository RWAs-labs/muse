...
var (
	pattern_Query_ForeignCoins_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"muse-chain", "fungible", "foreign_coins", "index"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ForeignCoinsAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"muse-chain", "fungible", "foreign_coins"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ForeignCoinsFromAsset_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"muse-chain", "fungible", "foreign_coins", "chain_id", "asset"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SystemContract_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"muse-chain", "fungible", "system_contract"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_GasStabilityPoolAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"muse-chain", "fungible", "gas_stability_pool_address"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_GasStabilityPoolBalance_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"muse-chain", "fungible", "gas_stability_pool_balance", "chain_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_GasStabilityPoolBalanceAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"muse-chain", "musecore", "fungible", "gas_stability_pool_balance"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_CodeHash_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"muse-chain", "fungible", "code_hash", "address"}, "", runtime.AssumeColonVerbOpt(false)))
)
