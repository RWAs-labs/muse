...
func CmdDeployFungibleCoinMRC4() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "deploy-fungible-coin-mrc-4 [erc-20] [foreign-chain] [decimals] [name] [symbol] [coin-type] [gas-limit] [liquidity-cap]",
		Short: "Broadcast message DeployFungibleCoinMRC20",
