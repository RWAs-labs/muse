...
import (
	...
	"github.com/RWAs-labs/muse/x/observer"
...
func TestGenesis(t *testing.T) {
	...
	t.Run("genState fields not defined", func(t *testing.T) {
		...
		musePrivnetChainParams := types.GetDefaultMusePrivnetChainParams()
		musePrivnetChainParams.IsSupported = true
		localnetChainParams := types.ChainParamsList{
			ChainParams: []*types.ChainParams{
				btcChainParams,
				goerliChainParams,
				musePrivnetChainParams,
			},
		}
