...
func CmdUpdateOperationalFlags() *cobra.Command {
	...
	cmd.Flags().Int64(restartHeightFlag, 0, "Height for a coordinated museclient restart")
	cmd.Flags().Duration(signerBlockTimeOffsetFlag, 0, "Offset from the musecore block time to initiate signing")
