...
func (cp ChainParams) Validate() error {
	// don't validate MuseChain params, because the validation will fail on existing params in the store
	// we might remove the MuseChain params in the future, this is TBD
	...
	// museclient will unconditionally use 'ConfirmationParams' fields in the future
	...
	if cp.MuseTokenContractAddress != "" && !validChainContractAddress(cp.MuseTokenContractAddress) {
		return fmt.Errorf(

			"invalid MuseTokenContractAddress %s",
			cp.MuseTokenContractAddress,
		)
	}
...
// https://github.com/RWAs-labs/muse-private/issues/100
...
func GetDefaultGoerliTestnetChainParams() *ChainParams {
	return &ChainParams{
		...
		ConfirmationCount: 6,
		// This is the actual Muse token Goerli testnet, we need to specify this address for the integration tests to pass
		MuseTokenContractAddress:    "0x0000c304d2934c00db1d51995b9f6996affd17c0",
		ConnectorContractAddress:    constant.EVMZeroAddress,
		Erc20CustodyContractAddress: constant.EVMZeroAddress,
		InboundTicker:               12,
		OutboundTicker:              15,
...
func GetDefaultGoerliLocalnetChainParams() *ChainParams {
	return &ChainParams{
		...
		ConfirmationCount:           1,
		MuseTokenContractAddress:    "0x733aB8b06DDDEf27Eaa72294B0d7c9cEF7f12db9",
...
func GetDefaultMusePrivnetChainParams() *ChainParams {
	return &ChainParams{
...
func ChainParamsEqual(params1, params2 ChainParams) bool {
	return params1.ChainId == params2.ChainId &&
		...
		params1.MuseTokenContractAddress == params2.MuseTokenContractAddress &&
