...
// source: musechain/musecore/observer/node_account.proto

package types

import (
	fmt "fmt"
	crypto "github.com/RWAs-labs/muse/pkg/crypto"
...
func (NodeStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_7c669f49ed632aea, []int{0}
}
...
type NodeAccount struct {
	...
	NodeStatus     NodeStatus        `protobuf:"varint,4,opt,name=nodeStatus,proto3,enum=musechain.musecore.observer.NodeStatus" json:"nodeStatus,omitempty"`
}
...
func init() {
	proto.RegisterEnum("musechain.musecore.observer.NodeStatus", NodeStatus_name, NodeStatus_value)
	proto.RegisterType((*NodeAccount)(nil), "musechain.musecore.observer.NodeAccount")
}

func init() {
	proto.RegisterFile("musechain/musecore/observer/node_account.proto", fileDescriptor_7c669f49ed632aea)
}

var fileDescriptor_7c669f49ed632aea = []byte{
	// 382 bytes of a gzipped FileDescriptorProto
	,
}
