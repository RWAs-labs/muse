...
func request_Query_GetTssAddressByFinalizedHeight_0(ctx context.Context, marshaler runtime.Marshaler, client QueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	val, ok = pathParams["finalized_muse_height"]
	if !ok {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "missing parameter %s", "finalized_muse_height")
	}

	protoReq.FinalizedMuseHeight, err = runtime.Int64(val)

	if err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "type mismatch, parameter: %s, error: %v", "finalized_muse_height", err)
	}
...
var (
	pattern_Query_HasVoted_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"muse-chain", "observer", "has_voted", "ballot_identifier", "voter_address"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_BallotByIdentifier_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"muse-chain", "observer", "ballot_by_identifier", "ballot_identifier"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_BallotListForHeight_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"muse-chain", "observer", "ballot_list_for_height", "height"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ObserverSet_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"muse-chain", "observer", "observer_set"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SupportedChains_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"muse-chain", "observer", "supportedChains"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_GetChainParamsForChain_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"muse-chain", "observer", "get_chain_params_for_chain", "chain_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_GetChainParams_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"muse-chain", "observer", "get_chain_params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_NodeAccount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"muse-chain", "observer", "nodeAccount", "index"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_NodeAccountAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"muse-chain", "observer", "nodeAccount"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_CrosschainFlags_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"muse-chain", "observer", "crosschain_flags"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Keygen_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"muse-chain", "observer", "keygen"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ShowObserverCount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"muse-chain", "musecore", "observer", "show_observer_count"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_BlameByIdentifier_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"muse-chain", "observer", "blame_by_identifier", "blame_identifier"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_GetAllBlameRecords_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"muse-chain", "observer", "get_all_blame_records"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_BlamesByChainAndNonce_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"muse-chain", "observer", "blame_by_chain_and_nonce", "chain_id", "nonce"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_GetTssAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"muse-chain", "observer", "get_tss_address", "bitcoin_chain_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_GetTssAddressByFinalizedHeight_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"muse-chain", "observer", "get_tss_address_historical", "finalized_muse_height", "bitcoin_chain_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_TSS_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"muse-chain", "observer", "TSS"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_TssHistory_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"muse-chain", "observer", "tssHistory"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_PendingNoncesAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"muse-chain", "observer", "pendingNonces"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_PendingNoncesByChain_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"muse-chain", "observer", "pendingNonces", "chain_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ChainNonces_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"muse-chain", "observer", "chainNonces", "chain_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ChainNoncesAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"muse-chain", "observer", "chainNonces"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_TssFundsMigratorInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"muse-chain", "observer", "getTssFundsMigrator"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_TssFundsMigratorInfoAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"muse-chain", "observer", "getAllTssFundsMigrators"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_OperationalFlags_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"muse-chain", "observer", "operationalFlags"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Ballots_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"muse-chain", "observer", "ballots"}, "", runtime.AssumeColonVerbOpt(false)))
)
