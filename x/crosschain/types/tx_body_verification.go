...
func VerifyInboundBody(
	...
	// https://github.com/RWAs-labs/muse/issues/2385
	...
	// https://github.com/RWAs-labs/muse/issues/1993

	return fmt.Errorf("cannot verify inbound body for chain %d", msg.ChainId)
}

// verifyInboundBodyEVM validates the chain id and connector contract address for Muse, ERC20 custody contract address for ERC20 and TSS address for Gas.
func verifyInboundBodyEVM(
	...
	case coin.CoinType_Muse:
		// Inbound depositing MUSE interacts with connector contract
...
// https://github.com/RWAs-labs/muse/issues/1994
