...
func TestValidateAddressForChain(t *testing.T) {
	...
	require.NoError(
		t,
		types.ValidateAddressForChain("bcrt1qs758ursh4q9z627kt3pp5yysm78ddny6txaqgw", chains.MuseChainMainnet.ChainId),
	)
	require.NoError(
		t,
		types.ValidateAddressForChain("0x792c127Fa3AC1D52F904056Baf1D9257391e7D78", chains.MuseChainMainnet.ChainId),
	)
}
...
func TestValidateCCTXIndex(t *testing.T) {
	...
	require.NoError(t, types.ValidateCCTXIndex(sample.MuseIndex(t)))
