...
// It is no longer used, but the function is kept for backward compatibility with the Muse Conversion Rate query
...
const (
	...
	// MuseAccountingKey value is used as prefix for storing MuseAccountingKey
	// #nosec G101: Potential hardcoded credentials (gosec)
	MuseAccountingKey = "MuseAccounting-value-"
