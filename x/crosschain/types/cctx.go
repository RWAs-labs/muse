...
func (m CrossChainTx) GetConnectedChainID() (int64, bool, error) {
	...
	// If the sender chain ID is MuseChain, this is an outgoing CCTX.
	// Note: additional chains argument is empty, all MuseChain IDs are hardcoded in the codebase.
	if chains.IsMuseChain(m.InboundParams.SenderChainId, []chains.Chain{}) {
...
func (m *CrossChainTx) AddRevertOutbound(gasLimit uint64) error {
	...
	// NOTE: this logic was not removed directly in https://github.com/RWAs-labs/muse/issues/2711
	...
	// https://github.com/RWAs-labs/muse/issues/3431
	...
	// TODO : Refactor to move FungibleTokenCoinType field to the CCTX object directly : https://github.com/RWAs-labs/muse/issues/1943
	if m.InboundParams != nil {
...
func NewCCTX(ctx sdk.Context, msg MsgVoteInbound, tssPubkey string) (CrossChainTx, error) {
	...
	// https://github.com/RWAs-labs/muse/issues/2236
	err := cctx.Validate()
	if err != nil {
