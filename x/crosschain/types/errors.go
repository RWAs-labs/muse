...
var (
	...
	ErrNotEnoughMuseBurnt      = errorsmod.Register(ModuleName, 1109, "not enough muse burnt")
	...
	ErrUnableToFindMuseAccounting    = errorsmod.Register(ModuleName, 1149, "unable to find muse accounting")
	ErrInsufficientMuseAmount        = errorsmod.Register(ModuleName, 1150, "insufficient muse amount")
