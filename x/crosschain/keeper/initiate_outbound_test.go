...
func TestKeeper_InitiateOutboundMEVMDeposit(t *testing.T) {
	t.Run("process mevm deposit successfully", func(t *testing.T) {
	...
	t.Run("unable to process mevm deposit HandleEVMDeposit returns err without reverting", func(t *testing.T) {
		k, ctx, _, _ := keepertest.CrosschainKeeperWithMocks(t, keepertest.CrosschainMockOptions{
			UseFungibleMock: true,
		})
		...
		fungibleMock.On("MUSEDepositAndCallContract", mock.Anything, mock.Anything, receiver, int64(0), amount, mock.Anything, mock.Anything).
	...
	t.Run(
		"unable to process mevm deposit HandleEVMDeposit reverts fails at GetSupportedChainFromChainID",
		func(t *testing.T) {
			k, ctx, _, _ := keepertest.CrosschainKeeperWithMocks(t, keepertest.CrosschainMockOptions{
				UseFungibleMock: true,
	...
	t.Run("unable to process mevm deposit HandleEVMDeposit revert fails at GetRevertGasLimit", func(t *testing.T) {
		k, ctx, _, _ := keepertest.CrosschainKeeperWithMocks(t, keepertest.CrosschainMockOptions{
			UseFungibleMock: true,
			UseObserverMock: true,
		})
	...
	t.Run("unable to process mevm deposit HandleEVMDeposit revert fails at PayGasInERC20AndUpdateCctx",
		func(t *testing.T) {
			k, ctx, _, _ := keepertest.CrosschainKeeperWithMocks(t, keepertest.CrosschainMockOptions{
				UseFungibleMock: true,
				UseObserverMock: true,
	...
	t.Run(
		"uunable to process mevm deposit HandleEVMDeposit revert fails at PayGasInERC20AndUpdateCctx with gas limit is 0",
		func(t *testing.T) {
			k, ctx, _, _ := keepertest.CrosschainKeeperWithMocks(t, keepertest.CrosschainMockOptions{
				UseFungibleMock: true,
				UseObserverMock: true,
	...
	t.Run("unable to process mevm deposit HandleEVMDeposit reverts fails at UpdateNonce", func(t *testing.T) {
		k, ctx, _, _ := keepertest.CrosschainKeeperWithMocks(t, keepertest.CrosschainMockOptions{
			UseFungibleMock: true,
			UseObserverMock: true,
		})
	...
	t.Run("unable to process mevm deposit HandleEVMDeposit revert successfully", func(t *testing.T) {
		k, ctx, _, _ := keepertest.CrosschainKeeperWithMocks(t, keepertest.CrosschainMockOptions{
			UseFungibleMock: true,
			UseObserverMock: true,
		})
	...
	t.Run("unable to process mevm deposit HandleEVMDeposit revert fails as the cctx has already been reverted",
		func(t *testing.T) {
			k, ctx, _, _ := keepertest.CrosschainKeeperWithMocks(t, keepertest.CrosschainMockOptions{
				UseFungibleMock: true,
				UseObserverMock: true,
