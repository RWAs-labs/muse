...
func setObservers(t *testing.T, k *keeper.Keeper, ctx sdk.Context, zk keepertest.MuseKeepers) []string {
...
// https://github.com/RWAs-labs/muse/issues/1542
...
func GetERC20Cctx(
	...
	cctx := &types.CrossChainTx{
		...
		MuseFees:       sample.UintInRange(0, 100),
		RelayedMessage: "",
	...
	cctx.GetInboundParams().BallotIndex = sample.MuseIndex(t)
	...
	cctx.GetCurrentOutboundParam().BallotIndex = sample.MuseIndex(t)
