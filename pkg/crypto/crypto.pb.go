...
// source: musechain/musecore/pkg/crypto/crypto.proto
...
func (*PubKeySet) Descriptor() ([]byte, []int) {
	return fileDescriptor_804414a6513d3056, []int{0}
}
...
func init() {
	proto.RegisterType((*PubKeySet)(nil), "musechain.musecore.pkg.crypto.PubKeySet")
}

func init() {
	proto.RegisterFile("musechain/musecore/pkg/crypto/crypto.proto", fileDescriptor_804414a6513d3056)
}

var fileDescriptor_804414a6513d3056 = []byte{
	...
	0x28, 0x4d, 0xd2, 0x4b, 0xce, 0xcf, 0xd5, 0x0f, 0x0a, 0x77, 0x2c, 0xd6, 0xcd, 0x49, 0x4c, 0x2a,
	0x06, 0xfb, 0x17, 0xc9, 0xaf, 0x49, 0x6c, 0x60, 0x07, 0x1b, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff,
	0x4f, 0x44, 0xb2, 0x80, 0x13, 0x01, 0x00, 0x00,
}
