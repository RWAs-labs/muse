...
// github.com/RWAs-labs/protocol-contracts-ton/blob/main/contracts/gateway.fc
// Inbound operations
const (
...
// Muse: https://github.com/RWAs-labs/protocol-contracts-ton/blob/main/contracts/common/errors.fc
