...
import (
	...
	"github.com/RWAs-labs/muse/pkg/proofs/bitcoin"
)
...
func (h HeaderData) ValidateTimestamp(museTime time.Time) error {
	switch data := h.Data.(type) {
	case *HeaderData_EthereumHeader:
	...
	case *HeaderData_BitcoinHeader:
		...
		maxTimestamp := museTime.Add(time.Second * blockchain.MaxTimeOffsetSeconds)
