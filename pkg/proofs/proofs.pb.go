...
// source: musechain/musecore/pkg/proofs/proofs.proto

package proofs

import (
	fmt "fmt"
	bitcoin "github.com/RWAs-labs/muse/pkg/proofs/bitcoin"
	ethereum "github.com/RWAs-labs/muse/pkg/proofs/ethereum"
...
func (*BlockHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_82d44aa8ab0ec138, []int{0}
}
...
func (*HeaderData) Descriptor() ([]byte, []int) {
	return fileDescriptor_82d44aa8ab0ec138, []int{1}
}
...
func (*Proof) Descriptor() ([]byte, []int) {
	return fileDescriptor_82d44aa8ab0ec138, []int{2}
}
...
func init() {
	proto.RegisterType((*BlockHeader)(nil), "musechain.musecore.pkg.proofs.BlockHeader")
	proto.RegisterType((*HeaderData)(nil), "musechain.musecore.pkg.proofs.HeaderData")
	proto.RegisterType((*Proof)(nil), "musechain.musecore.pkg.proofs.Proof")
}

func init() {
	proto.RegisterFile("musechain/musecore/pkg/proofs/proofs.proto", fileDescriptor_82d44aa8ab0ec138)
}

var fileDescriptor_82d44aa8ab0ec138 = []byte{
	// 399 bytes of a gzipped FileDescriptorProto
	,
}
