...
const (
	// defaultInboundFastConfirmationLiquidityDivisor is the default MRC20 liquidity cap divisor for inbound fast confirmation
...
var (
	// customInboundFastConfirmationLiquidityDivisorMap maps chainID to custom MRC20 liquidity cap divisor for inbound fast confirmation.
...
// getInboundFastConfirmationLiquidityDivisor returns the MRC20 liquidity cap divisor for inbound fast confirmation.
