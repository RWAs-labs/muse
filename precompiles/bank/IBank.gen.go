...
var IBankMetaData = &bind.MetaData{
	ABI: "[{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"mrc20_depositor\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"mrc20_token\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"string\",\"name\":\"cosmos_token\",\"type\":\"string\"},{\"indexed\":false,\"internalType\":\"string\",\"name\":\"cosmos_address\",\"type\":\"string\"},{\"indexed\":false,\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"}],\"name\":\"Deposit\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"mrc20_withdrawer\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"mrc20_token\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"string\",\"name\":\"cosmos_token\",\"type\":\"string\"},{\"indexed\":false,\"internalType\":\"string\",\"name\":\"cosmos_address\",\"type\":\"string\"},{\"indexed\":false,\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"}],\"name\":\"Withdraw\",\"type\":\"event\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"mrc20\",\"type\":\"address\"},{\"internalType\":\"address\",\"name\":\"user\",\"type\":\"address\"}],\"name\":\"balanceOf\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"balance\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"mrc20\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"}],\"name\":\"deposit\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"success\",\"type\":\"bool\"}],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"mrc20\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"}],\"name\":\"withdraw\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"success\",\"type\":\"bool\"}],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]",
}
...
//
// Solidity: function balanceOf(address mrc20, address user) view returns(uint256 balance)
func (_IBank *IBankCaller) BalanceOf(opts *bind.CallOpts, mrc20 common.Address, user common.Address) (*big.Int, error) {
	var out []interface{}
	err := _IBank.contract.Call(opts, &out, "balanceOf", mrc20, user)
...
//
// Solidity: function balanceOf(address mrc20, address user) view returns(uint256 balance)
func (_IBank *IBankSession) BalanceOf(mrc20 common.Address, user common.Address) (*big.Int, error) {
	return _IBank.Contract.BalanceOf(&_IBank.CallOpts, mrc20, user)
}

// BalanceOf is a free data retrieval call binding the contract method 0xf7888aec.
//
// Solidity: function balanceOf(address mrc20, address user) view returns(uint256 balance)
func (_IBank *IBankCallerSession) BalanceOf(mrc20 common.Address, user common.Address) (*big.Int, error) {
	return _IBank.Contract.BalanceOf(&_IBank.CallOpts, mrc20, user)
}

// Deposit is a paid mutator transaction binding the contract method 0x47e7ef24.
//
// Solidity: function deposit(address mrc20, uint256 amount) returns(bool success)
func (_IBank *IBankTransactor) Deposit(opts *bind.TransactOpts, mrc20 common.Address, amount *big.Int) (*types.Transaction, error) {
	return _IBank.contract.Transact(opts, "deposit", mrc20, amount)
}

// Deposit is a paid mutator transaction binding the contract method 0x47e7ef24.
//
// Solidity: function deposit(address mrc20, uint256 amount) returns(bool success)
func (_IBank *IBankSession) Deposit(mrc20 common.Address, amount *big.Int) (*types.Transaction, error) {
	return _IBank.Contract.Deposit(&_IBank.TransactOpts, mrc20, amount)
}

// Deposit is a paid mutator transaction binding the contract method 0x47e7ef24.
//
// Solidity: function deposit(address mrc20, uint256 amount) returns(bool success)
func (_IBank *IBankTransactorSession) Deposit(mrc20 common.Address, amount *big.Int) (*types.Transaction, error) {
	return _IBank.Contract.Deposit(&_IBank.TransactOpts, mrc20, amount)
}

// Withdraw is a paid mutator transaction binding the contract method 0xf3fef3a3.
//
// Solidity: function withdraw(address mrc20, uint256 amount) returns(bool success)
func (_IBank *IBankTransactor) Withdraw(opts *bind.TransactOpts, mrc20 common.Address, amount *big.Int) (*types.Transaction, error) {
	return _IBank.contract.Transact(opts, "withdraw", mrc20, amount)
}

// Withdraw is a paid mutator transaction binding the contract method 0xf3fef3a3.
//
// Solidity: function withdraw(address mrc20, uint256 amount) returns(bool success)
func (_IBank *IBankSession) Withdraw(mrc20 common.Address, amount *big.Int) (*types.Transaction, error) {
	return _IBank.Contract.Withdraw(&_IBank.TransactOpts, mrc20, amount)
}

// Withdraw is a paid mutator transaction binding the contract method 0xf3fef3a3.
//
// Solidity: function withdraw(address mrc20, uint256 amount) returns(bool success)
func (_IBank *IBankTransactorSession) Withdraw(mrc20 common.Address, amount *big.Int) (*types.Transaction, error) {
	return _IBank.Contract.Withdraw(&_IBank.TransactOpts, mrc20, amount)
}
...
//
// Solidity: event Deposit(address indexed mrc20_depositor, address indexed mrc20_token, string indexed cosmos_token, string cosmos_address, uint256 amount)
func (_IBank *IBankFilterer) FilterDeposit(opts *bind.FilterOpts, mrc20_depositor []common.Address, mrc20_token []common.Address, cosmos_token []string) (*IBankDepositIterator, error) {

	var mrc20_depositorRule []interface{}
	for _, mrc20_depositorItem := range mrc20_depositor {
		mrc20_depositorRule = append(mrc20_depositorRule, mrc20_depositorItem)
	}
	var mrc20_tokenRule []interface{}
	for _, mrc20_tokenItem := range mrc20_token {
		mrc20_tokenRule = append(mrc20_tokenRule, mrc20_tokenItem)
	}
	...
	logs, sub, err := _IBank.contract.FilterLogs(opts, "Deposit", mrc20_depositorRule, mrc20_tokenRule, cosmos_tokenRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Deposit(address indexed mrc20_depositor, address indexed mrc20_token, string indexed cosmos_token, string cosmos_address, uint256 amount)
func (_IBank *IBankFilterer) WatchDeposit(opts *bind.WatchOpts, sink chan<- *IBankDeposit, mrc20_depositor []common.Address, mrc20_token []common.Address, cosmos_token []string) (event.Subscription, error) {
	...
	logs, sub, err := _IBank.contract.WatchLogs(opts, "Deposit", mrc20_depositorRule, mrc20_tokenRule, cosmos_tokenRule)
	if err != nil {
		return nil, err
	}
...
type IBankWithdraw struct {
	Mrc20Withdrawer common.Address
	Mrc20Token      common.Address
	CosmosToken     common.Hash
	CosmosAddress   string
	Amount          *big.Int
...
//
// Solidity: event Withdraw(address indexed mrc20_withdrawer, address indexed mrc20_token, string indexed cosmos_token, string cosmos_address, uint256 amount)
func (_IBank *IBankFilterer) FilterWithdraw(opts *bind.FilterOpts, mrc20_withdrawer []common.Address, mrc20_token []common.Address, cosmos_token []string) (*IBankWithdrawIterator, error) {

	var mrc20_withdrawerRule []interface{}
	for _, mrc20_withdrawerItem := range mrc20_withdrawer {
		mrc20_withdrawerRule = append(mrc20_withdrawerRule, mrc20_withdrawerItem)
	}
	var mrc20_tokenRule []interface{}
	for _, mrc20_tokenItem := range mrc20_token {
		mrc20_tokenRule = append(mrc20_tokenRule, mrc20_tokenItem)
	...
	logs, sub, err := _IBank.contract.FilterLogs(opts, "Withdraw", mrc20_withdrawerRule, mrc20_tokenRule, cosmos_tokenRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Withdraw(address indexed mrc20_withdrawer, address indexed mrc20_token, string indexed cosmos_token, string cosmos_address, uint256 amount)
func (_IBank *IBankFilterer) WatchWithdraw(opts *bind.WatchOpts, sink chan<- *IBankWithdraw, mrc20_withdrawer []common.Address, mrc20_token []common.Address, cosmos_token []string) (event.Subscription, error) {
	...
	logs, sub, err := _IBank.contract.WatchLogs(opts, "Withdraw", mrc20_withdrawerRule, mrc20_tokenRule, cosmos_tokenRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
