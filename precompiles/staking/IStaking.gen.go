...
//
// Solidity: function distribute(address mrc20, uint256 amount) returns(bool success)
func (_IStaking *IStakingTransactor) Distribute(opts *bind.TransactOpts, mrc20 common.Address, amount *big.Int) (*types.Transaction, error) {
	return _IStaking.contract.Transact(opts, "distribute", mrc20, amount)
}

// Distribute is a paid mutator transaction binding the contract method 0xfb932108.
//
// Solidity: function distribute(address mrc20, uint256 amount) returns(bool success)
func (_IStaking *IStakingSession) Distribute(mrc20 common.Address, amount *big.Int) (*types.Transaction, error) {
	return _IStaking.Contract.Distribute(&_IStaking.TransactOpts, mrc20, amount)
}

// Distribute is a paid mutator transaction binding the contract method 0xfb932108.
//
// Solidity: function distribute(address mrc20, uint256 amount) returns(bool success)
func (_IStaking *IStakingTransactorSession) Distribute(mrc20 common.Address, amount *big.Int) (*types.Transaction, error) {
	return _IStaking.Contract.Distribute(&_IStaking.TransactOpts, mrc20, amount)
}
...
//
// Solidity: event ClaimedRewards(address indexed claim_address, address indexed mrc20_token, address indexed validator, uint256 amount)
func (_IStaking *IStakingFilterer) FilterClaimedRewards(opts *bind.FilterOpts, claim_address []common.Address, mrc20_token []common.Address, validator []common.Address) (*IStakingClaimedRewardsIterator, error) {
	...
	logs, sub, err := _IStaking.contract.FilterLogs(opts, "ClaimedRewards", claim_addressRule, mrc20_tokenRule, validatorRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event ClaimedRewards(address indexed claim_address, address indexed mrc20_token, address indexed validator, uint256 amount)
func (_IStaking *IStakingFilterer) WatchClaimedRewards(opts *bind.WatchOpts, sink chan<- *IStakingClaimedRewards, claim_address []common.Address, mrc20_token []common.Address, validator []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _IStaking.contract.WatchLogs(opts, "ClaimedRewards", claim_addressRule, mrc20_tokenRule, validatorRule)
	if err != nil {
		return nil, err
	}
...
type IStakingDistributed struct {
	Mrc20Distributor common.Address
	Mrc20Token       common.Address
	Amount           *big.Int
	Raw              types.Log // Blockchain specific contextual infos
}
...
//
// Solidity: event Distributed(address indexed mrc20_distributor, address indexed mrc20_token, uint256 amount)
func (_IStaking *IStakingFilterer) FilterDistributed(opts *bind.FilterOpts, mrc20_distributor []common.Address, mrc20_token []common.Address) (*IStakingDistributedIterator, error) {

	var mrc20_distributorRule []interface{}
	for _, mrc20_distributorItem := range mrc20_distributor {
		mrc20_distributorRule = append(mrc20_distributorRule, mrc20_distributorItem)
	}
	var mrc20_tokenRule []interface{}
	for _, mrc20_tokenItem := range mrc20_token {
		mrc20_tokenRule = append(mrc20_tokenRule, mrc20_tokenItem)
	...
	logs, sub, err := _IStaking.contract.FilterLogs(opts, "Distributed", mrc20_distributorRule, mrc20_tokenRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Distributed(address indexed mrc20_distributor, address indexed mrc20_token, uint256 amount)
func (_IStaking *IStakingFilterer) WatchDistributed(opts *bind.WatchOpts, sink chan<- *IStakingDistributed, mrc20_distributor []common.Address, mrc20_token []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _IStaking.contract.WatchLogs(opts, "Distributed", mrc20_distributorRule, mrc20_tokenRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
