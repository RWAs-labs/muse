...
interface IStaking {
    ...
    /// @param mrc20_distributor Distributor address.
    /// @param mrc20_token MRC20 token address.
    /// @param amount Distributed amount.
    event Distributed(
        address indexed mrc20_distributor,
        address indexed mrc20_token,
        uint256 amount
    );

    /// @notice ClaimedRewards is emitted when a delegator claims MRC20.
    ...
    /// @notice Distribute a MRC20 token as staking rewards.
    /// @param mrc20 The MRC20 token address to be distributed.
    /// @param amount The amount of MRC20 tokens to distribute.
    ...
    /// @notice Claim MRC20 staking rewards.
    ...
    /// @notice Query MRC20 outstanding staking rewards.
    /// @param delegator The delegator address to query rewards from.
