module github.com/RWAs-labs/muse/contrib/rpcimportable
...
replace (
    github.com/ethereum/go-ethereum => github.com/RWAs-labs/go-ethereum v1.13.16-0.20241022183758-422c6ef93ccc
)

// uncomment this for local development/testing/debugging
// replace github.com/muse-chain/node => ../..