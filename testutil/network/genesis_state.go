...
import (
	...
	cmdcfg "github.com/RWAs-labs/muse/cmd/musecored/config"
		...
		Items: []*authoritytypes.Policy{
			{
				...
				Address:    "muse13c7p3xrhd6q2rx3h235jpt8pjdwvacyw6twpax",
			},
			{
