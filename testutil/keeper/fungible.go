...
import (
	...
	fungiblemocks "github.com/RWAs-labs/muse/testutil/keeper/mocks/fungible"
...
func FungibleKeeper(t testing.TB) (*keeper.Keeper, sdk.Context, SDKKeepers, MuseKeepers) {
