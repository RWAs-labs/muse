...
import (
	...
	crosschainmocks "github.com/RWAs-labs/muse/testutil/keeper/mocks/crosschain"
...
func CrosschainKeeper(t testing.TB) (*keeper.Keeper, sdk.Context, SDKKeepers, MuseKeepers) {
...
func MockPayGasAndUpdateCCTX(
	...
	m.On("QuerySystemContractGasCoinMRC20", mock.Anything, mock.Anything).
	...
	m.On("QueryUniswapV2RouterGetMRC4ToMRC4AmountsIn", mock.Anything, mock.Anything, mock.Anything, mock.Anything).
		Return(big.NewInt(0), nil).Once()
	m.On("DepositMRC20", mock.Anything, mock.Anything, mock.Anything, mock.Anything).
		Return(&evmtypes.MsgEthereumTxResponse{}, nil)
	m.On("GetUniswapV2Router02Address", mock.Anything).
		Return(ethcommon.Address{}, nil).Once()
	m.On("CallMRC20Approve", mock.Anything, mock.Anything, mock.Anything, mock.Anything, mock.Anything, mock.Anything).
		Return(nil).Once()
	m.On("CallUniswapV2RouterSwapExactTokensForTokens", mock.Anything, mock.Anything, mock.Anything, mock.Anything, mock.Anything, mock.Anything, mock.Anything).
		...
		Once()
	m.On("CallMRC20Burn", mock.Anything, mock.Anything, mock.Anything, mock.Anything, mock.Anything).
		Return(nil).Once()
}
