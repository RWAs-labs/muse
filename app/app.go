...
import (
	...
	"github.com/RWAs-labs/muse/docs/openapi"
	musemempool "github.com/RWAs-labs/muse/pkg/mempool"
	"github.com/RWAs-labs/muse/precompiles"
...
// https://github.com/RWAs-labs/muse/issues/2573
...
// "github.com/RWAs-labs/muse/x/ibccrosschain"
...
// New returns a reference to an initialized MuseApp.
func New(
	logger log.Logger,
	db dbm.DB,
	...
	customProposalHandler := musemempool.NewCustomProposalHandler(bApp.Mempool(), bApp)
...
https://www.musechain.com/docs/nodes/start-here/syncing/`
...
// AppCodec returns Muse app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
