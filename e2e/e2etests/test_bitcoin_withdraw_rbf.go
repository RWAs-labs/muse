...
// TestBitcoinWithdrawRBF tests the RBF (Replace-By-Fee) feature in Museclient.
...
//     here: https://github.com/RWAs-labs/muse/blob/5c2a8ffbc702130fd9538b1cd7640d0e04d3e4f6/museclient/chains/bitcoin/observer/outbound.go#L27
...
func TestBitcoinWithdrawRBF(r *runner.E2ERunner, args []string) {
	...
	tx := r.WithdrawBTC(to, amount, gatewaymevm.RevertOptions{OnRevertGasLimit: big.NewInt(0)}, true)
