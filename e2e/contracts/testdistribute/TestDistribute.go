...
//
// Solidity: function distributeThroughContract(address mrc20, uint256 amount) returns(bool)
func (_TestDistribute *TestDistributeTransactor) DistributeThroughContract(opts *bind.TransactOpts, mrc20 common.Address, amount *big.Int) (*types.Transaction, error) {
	return _TestDistribute.contract.Transact(opts, "distributeThroughContract", mrc20, amount)
}

// DistributeThroughContract is a paid mutator transaction binding the contract method 0x50b54e84.
//
// Solidity: function distributeThroughContract(address mrc20, uint256 amount) returns(bool)
func (_TestDistribute *TestDistributeSession) DistributeThroughContract(mrc20 common.Address, amount *big.Int) (*types.Transaction, error) {
	return _TestDistribute.Contract.DistributeThroughContract(&_TestDistribute.TransactOpts, mrc20, amount)
}

// DistributeThroughContract is a paid mutator transaction binding the contract method 0x50b54e84.
//
// Solidity: function distributeThroughContract(address mrc20, uint256 amount) returns(bool)
func (_TestDistribute *TestDistributeTransactorSession) DistributeThroughContract(mrc20 common.Address, amount *big.Int) (*types.Transaction, error) {
	return _TestDistribute.Contract.DistributeThroughContract(&_TestDistribute.TransactOpts, mrc20, amount)
}
