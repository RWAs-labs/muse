...
var TestBankMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"stateMutability\":\"payable\",\"type\":\"fallback\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"mrc20\",\"type\":\"address\"},{\"internalType\":\"address\",\"name\":\"user\",\"type\":\"address\"}],\"name\":\"balanceOf\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"mrc20\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"}],\"name\":\"deposit\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"mrc20\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"}],\"name\":\"withdraw\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"stateMutability\":\"payable\",\"type\":\"receive\"}]",
...
//
// Solidity: function balanceOf(address mrc20, address user) view returns(uint256)
func (_TestBank *TestBankCaller) BalanceOf(opts *bind.CallOpts, mrc20 common.Address, user common.Address) (*big.Int, error) {
	var out []interface{}
	err := _TestBank.contract.Call(opts, &out, "balanceOf", mrc20, user)
...
//
// Solidity: function balanceOf(address mrc20, address user) view returns(uint256)
func (_TestBank *TestBankSession) BalanceOf(mrc20 common.Address, user common.Address) (*big.Int, error) {
	return _TestBank.Contract.BalanceOf(&_TestBank.CallOpts, mrc20, user)
}

// BalanceOf is a free data retrieval call binding the contract method 0xf7888aec.
//
// Solidity: function balanceOf(address mrc20, address user) view returns(uint256)
func (_TestBank *TestBankCallerSession) BalanceOf(mrc20 common.Address, user common.Address) (*big.Int, error) {
	return _TestBank.Contract.BalanceOf(&_TestBank.CallOpts, mrc20, user)
}

// Deposit is a paid mutator transaction binding the contract method 0x47e7ef24.
//
// Solidity: function deposit(address mrc20, uint256 amount) returns(bool)
func (_TestBank *TestBankTransactor) Deposit(opts *bind.TransactOpts, mrc20 common.Address, amount *big.Int) (*types.Transaction, error) {
	return _TestBank.contract.Transact(opts, "deposit", mrc20, amount)
}

// Deposit is a paid mutator transaction binding the contract method 0x47e7ef24.
//
// Solidity: function deposit(address mrc20, uint256 amount) returns(bool)
func (_TestBank *TestBankSession) Deposit(mrc20 common.Address, amount *big.Int) (*types.Transaction, error) {
	return _TestBank.Contract.Deposit(&_TestBank.TransactOpts, mrc20, amount)
}

// Deposit is a paid mutator transaction binding the contract method 0x47e7ef24.
//
// Solidity: function deposit(address mrc20, uint256 amount) returns(bool)
func (_TestBank *TestBankTransactorSession) Deposit(mrc20 common.Address, amount *big.Int) (*types.Transaction, error) {
	return _TestBank.Contract.Deposit(&_TestBank.TransactOpts, mrc20, amount)
}

// Withdraw is a paid mutator transaction binding the contract method 0xf3fef3a3.
//
// Solidity: function withdraw(address mrc20, uint256 amount) returns(bool)
func (_TestBank *TestBankTransactor) Withdraw(opts *bind.TransactOpts, mrc20 common.Address, amount *big.Int) (*types.Transaction, error) {
	return _TestBank.contract.Transact(opts, "withdraw", mrc20, amount)
}

// Withdraw is a paid mutator transaction binding the contract method 0xf3fef3a3.
//
// Solidity: function withdraw(address mrc20, uint256 amount) returns(bool)
func (_TestBank *TestBankSession) Withdraw(mrc20 common.Address, amount *big.Int) (*types.Transaction, error) {
	return _TestBank.Contract.Withdraw(&_TestBank.TransactOpts, mrc20, amount)
}

// Withdraw is a paid mutator transaction binding the contract method 0xf3fef3a3.
//
// Solidity: function withdraw(address mrc20, uint256 amount) returns(bool)
func (_TestBank *TestBankTransactorSession) Withdraw(mrc20 common.Address, amount *big.Int) (*types.Transaction, error) {
	return _TestBank.Contract.Withdraw(&_TestBank.TransactOpts, mrc20, amount)
}
