...
// TestGasConsumermContext is an auto generated low-level Go binding around an user-defined struct.
type TestGasConsumermContext struct {
	Origin  []byte
...
var TestGasConsumerMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"components\":[{\"internalType\":\"bytes\",\"name\":\"origin\",\"type\":\"bytes\"},{\"internalType\":\"address\",\"name\":\"sender\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"chainID\",\"type\":\"uint256\"}],\"internalType\":\"structTestGasConsumer.mContext\",\"name\":\"_context\",\"type\":\"tuple\"},{\"internalType\":\"address\",\"name\":\"_mrc20\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"_amount\",\"type\":\"uint256\"},{\"internalType\":\"bytes\",\"name\":\"_message\",\"type\":\"bytes\"}],\"name\":\"onCall\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]",
...
//
// Solidity: function onCall((bytes,address,uint256) _context, address _mrc20, uint256 _amount, bytes _message) returns()
func (_TestGasConsumer *TestGasConsumerTransactor) OnCall(opts *bind.TransactOpts, _context TestGasConsumermContext, _mrc20 common.Address, _amount *big.Int, _message []byte) (*types.Transaction, error) {
	return _TestGasConsumer.contract.Transact(opts, "onCall", _context, _mrc20, _amount, _message)
}

// OnCall is a paid mutator transaction binding the contract method 0x5bcfd616.
//
// Solidity: function onCall((bytes,address,uint256) _context, address _mrc20, uint256 _amount, bytes _message) returns()
func (_TestGasConsumer *TestGasConsumerSession) OnCall(_context TestGasConsumermContext, _mrc20 common.Address, _amount *big.Int, _message []byte) (*types.Transaction, error) {
	return _TestGasConsumer.Contract.OnCall(&_TestGasConsumer.TransactOpts, _context, _mrc20, _amount, _message)
}

// OnCall is a paid mutator transaction binding the contract method 0x5bcfd616.
//
// Solidity: function onCall((bytes,address,uint256) _context, address _mrc20, uint256 _amount, bytes _message) returns()
func (_TestGasConsumer *TestGasConsumerTransactorSession) OnCall(_context TestGasConsumermContext, _mrc20 common.Address, _amount *big.Int, _message []byte) (*types.Transaction, error) {
	return _TestGasConsumer.Contract.OnCall(&_TestGasConsumer.TransactOpts, _context, _mrc20, _amount, _message)
}
