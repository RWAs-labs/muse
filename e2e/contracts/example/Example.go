...
// ExamplemContext is an auto generated low-level Go binding around an user-defined struct.
type ExamplemContext struct {
	Sender    []byte
...
func (_Example *ExampleTransactor) OnCall(opts *bind.TransactOpts, context ExamplemContext, mrc20 common.Address, amount *big.Int, message []byte) (*types.Transaction, error) {
	return _Example.contract.Transact(opts, "onCall", context, mrc20, amount, message)
}

// OnCall is a paid mutator transaction binding the contract method 0x5bcfd616.
//
// Solidity: function onCall((bytes,address,uint256) context, address mrc20, uint256 amount, bytes message) returns()
func (_Example *ExampleSession) OnCall(context ExamplemContext, mrc20 common.Address, amount *big.Int, message []byte) (*types.Transaction, error) {
	return _Example.Contract.OnCall(&_Example.TransactOpts, context, mrc20, amount, message)
}

// OnCall is a paid mutator transaction binding the contract method 0x5bcfd616.
//
// Solidity: function onCall((bytes,address,uint256) context, address mrc20, uint256 amount, bytes message) returns()
func (_Example *ExampleTransactorSession) OnCall(context ExamplemContext, mrc20 common.Address, amount *big.Int, message []byte) (*types.Transaction, error) {
	return _Example.Contract.OnCall(&_Example.TransactOpts, context, mrc20, amount, message)
}
...
func (_Example *ExampleTransactor) OnCrossChainCall(opts *bind.TransactOpts, context ExamplemContext, mrc20 common.Address, amount *big.Int, message []byte) (*types.Transaction, error) {
	return _Example.contract.Transact(opts, "onCrossChainCall", context, mrc20, amount, message)
}

// OnCrossChainCall is a paid mutator transaction binding the contract method 0xde43156e.
//
// Solidity: function onCrossChainCall((bytes,address,uint256) context, address mrc20, uint256 amount, bytes message) returns()
func (_Example *ExampleSession) OnCrossChainCall(context ExamplemContext, mrc20 common.Address, amount *big.Int, message []byte) (*types.Transaction, error) {
	return _Example.Contract.OnCrossChainCall(&_Example.TransactOpts, context, mrc20, amount, message)
}

// OnCrossChainCall is a paid mutator transaction binding the contract method 0xde43156e.
//
// Solidity: function onCrossChainCall((bytes,address,uint256) context, address mrc20, uint256 amount, bytes message) returns()
func (_Example *ExampleTransactorSession) OnCrossChainCall(context ExamplemContext, mrc20 common.Address, amount *big.Int, message []byte) (*types.Transaction, error) {
	return _Example.Contract.OnCrossChainCall(&_Example.TransactOpts, context, mrc20, amount, message)
}
