...
func DeployTestStaking(auth *bind.TransactOpts, backend bind.ContractBackend, _wmuse common.Address) (common.Address, *types.Transaction, *TestStaking, error) {
	...
	address, tx, contract, err := bind.DeployContract(auth, *parsed, common.FromHex(TestStakingBin), backend, _wmuse)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
...
func (_TestStaking *TestStakingTransactor) DepositWMUSE(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _TestStaking.contract.Transact(opts, "depositWMUSE")
}

// DepositWMUSE is a paid mutator transaction binding the contract method 0x2c5d24ae.
//
// Solidity: function depositWMUSE() payable returns()
func (_TestStaking *TestStakingSession) DepositWMUSE() (*types.Transaction, error) {
	return _TestStaking.Contract.DepositWMUSE(&_TestStaking.TransactOpts)
}

// DepositWMUSE is a paid mutator transaction binding the contract method 0x2c5d24ae.
//
// Solidity: function depositWMUSE() payable returns()
func (_TestStaking *TestStakingTransactorSession) DepositWMUSE() (*types.Transaction, error) {
	return _TestStaking.Contract.DepositWMUSE(&_TestStaking.TransactOpts)
}
...
// WithdrawWMUSE is a paid mutator transaction binding the contract method 0x9a0fb673.
//
// Solidity: function withdrawWMUSE(uint256 wad) returns()
func (_TestStaking *TestStakingTransactor) WithdrawWMUSE(opts *bind.TransactOpts, wad *big.Int) (*types.Transaction, error) {
	return _TestStaking.contract.Transact(opts, "withdrawWMUSE", wad)
}

// WithdrawWMUSE is a paid mutator transaction binding the contract method 0x9a0fb673.
//
// Solidity: function withdrawWMUSE(uint256 wad) returns()
func (_TestStaking *TestStakingSession) WithdrawWMUSE(wad *big.Int) (*types.Transaction, error) {
	return _TestStaking.Contract.WithdrawWMUSE(&_TestStaking.TransactOpts, wad)
}

// WithdrawWMUSE is a paid mutator transaction binding the contract method 0x9a0fb673.
//
// Solidity: function withdrawWMUSE(uint256 wad) returns()
func (_TestStaking *TestStakingTransactorSession) WithdrawWMUSE(wad *big.Int) (*types.Transaction, error) {
	return _TestStaking.Contract.WithdrawWMUSE(&_TestStaking.TransactOpts, wad)
}
