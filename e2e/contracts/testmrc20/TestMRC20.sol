...
/**
 * @dev Interfaces of SystemContract and MRC20 to make easier to import.
 */
interface ISystem {
...
/// @dev Coin types for MRC20. Muse value should not be used.
enum CoinType {
    Muse,
    Gas,
    ERC20
...
/**
 * @dev TestMRC20.sol is a test implementation of MRC20 that extends the contract with new fields to test contract
 bytecode upgrade
 */
contract TestMRC20 is IMRC20, IMRC20Metadata, MRC20Errors {
    ...
    /**
     * @dev Returns MRC20 balance of an account.
     ...
     * @return returns the MRC20 address for gas on the same chain of this MRC20, and calculates the gas fee for withdraw()
     */
    ...
    /**
     * @dev Withraws MRC20 tokens to external chains, this function causes cctx module to send out outbound tx to the outbound chain
     * this contract should be given enough allowance of the gas MRC20 to pay for outbound tx gas fee.
     * @param to, recipient address.
     * @param amount, amount to deposit.
     * @return true/false if succeeded/failed.
     */
