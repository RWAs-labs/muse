...
func (_ContextApp *ContextAppTransactor) OnCrossChainCall(opts *bind.TransactOpts, context Context, mrc20 common.Address, amount *big.Int, message []byte) (*types.Transaction, error) {
	return _ContextApp.contract.Transact(opts, "onCrossChainCall", context, mrc20, amount, message)
}

// OnCrossChainCall is a paid mutator transaction binding the contract method 0xde43156e.
//
// Solidity: function onCrossChainCall((bytes,address,uint256) context, address mrc20, uint256 amount, bytes message) returns()
func (_ContextApp *ContextAppSession) OnCrossChainCall(context Context, mrc20 common.Address, amount *big.Int, message []byte) (*types.Transaction, error) {
	return _ContextApp.Contract.OnCrossChainCall(&_ContextApp.TransactOpts, context, mrc20, amount, message)
}

// OnCrossChainCall is a paid mutator transaction binding the contract method 0xde43156e.
//
// Solidity: function onCrossChainCall((bytes,address,uint256) context, address mrc20, uint256 amount, bytes message) returns()
func (_ContextApp *ContextAppTransactorSession) OnCrossChainCall(context Context, mrc20 common.Address, amount *big.Int, message []byte) (*types.Transaction, error) {
	return _ContextApp.Contract.OnCrossChainCall(&_ContextApp.TransactOpts, context, mrc20, amount, message)
}
