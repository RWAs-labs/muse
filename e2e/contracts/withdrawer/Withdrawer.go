...
//
// Solidity: function onCall((bytes,address,uint256) context, address mrc20, uint256 , bytes ) returns()
func (_Withdrawer *WithdrawerTransactor) OnCall(opts *bind.TransactOpts, context Context, mrc20 common.Address, arg2 *big.Int, arg3 []byte) (*types.Transaction, error) {
	return _Withdrawer.contract.Transact(opts, "onCall", context, mrc20, arg2, arg3)
}

// OnCall is a paid mutator transaction binding the contract method 0x5bcfd616.
//
// Solidity: function onCall((bytes,address,uint256) context, address mrc20, uint256 , bytes ) returns()
func (_Withdrawer *WithdrawerSession) OnCall(context Context, mrc20 common.Address, arg2 *big.Int, arg3 []byte) (*types.Transaction, error) {
	return _Withdrawer.Contract.OnCall(&_Withdrawer.TransactOpts, context, mrc20, arg2, arg3)
}

// OnCall is a paid mutator transaction binding the contract method 0x5bcfd616.
//
// Solidity: function onCall((bytes,address,uint256) context, address mrc20, uint256 , bytes ) returns()
func (_Withdrawer *WithdrawerTransactorSession) OnCall(context Context, mrc20 common.Address, arg2 *big.Int, arg3 []byte) (*types.Transaction, error) {
	return _Withdrawer.Contract.OnCall(&_Withdrawer.TransactOpts, context, mrc20, arg2, arg3)
}

// OnCrossChainCall is a paid mutator transaction binding the contract method 0xde43156e.
//
// Solidity: function onCrossChainCall((bytes,address,uint256) context, address mrc20, uint256 , bytes ) returns()
func (_Withdrawer *WithdrawerTransactor) OnCrossChainCall(opts *bind.TransactOpts, context Context, mrc20 common.Address, arg2 *big.Int, arg3 []byte) (*types.Transaction, error) {
	return _Withdrawer.contract.Transact(opts, "onCrossChainCall", context, mrc20, arg2, arg3)
}

// OnCrossChainCall is a paid mutator transaction binding the contract method 0xde43156e.
//
// Solidity: function onCrossChainCall((bytes,address,uint256) context, address mrc20, uint256 , bytes ) returns()
func (_Withdrawer *WithdrawerSession) OnCrossChainCall(context Context, mrc20 common.Address, arg2 *big.Int, arg3 []byte) (*types.Transaction, error) {
	return _Withdrawer.Contract.OnCrossChainCall(&_Withdrawer.TransactOpts, context, mrc20, arg2, arg3)
}

// OnCrossChainCall is a paid mutator transaction binding the contract method 0xde43156e.
//
// Solidity: function onCrossChainCall((bytes,address,uint256) context, address mrc20, uint256 , bytes ) returns()
func (_Withdrawer *WithdrawerTransactorSession) OnCrossChainCall(context Context, mrc20 common.Address, arg2 *big.Int, arg3 []byte) (*types.Transaction, error) {
	return _Withdrawer.Contract.OnCrossChainCall(&_Withdrawer.TransactOpts, context, mrc20, arg2, arg3)
}
