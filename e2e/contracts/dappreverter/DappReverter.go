...
var DappReverterMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[],\"name\":\"onMuseMessage\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"onMuseRevert\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]",
...
// OnMuseMessage is a paid mutator transaction binding the contract method 0x705847b7.
//
// Solidity: function onMuseMessage() returns()
func (_DappReverter *DappReverterTransactor) OnMuseMessage(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _DappReverter.contract.Transact(opts, "onMuseMessage")
}

// OnMuseMessage is a paid mutator transaction binding the contract method 0x705847b7.
//
// Solidity: function onMuseMessage() returns()
func (_DappReverter *DappReverterSession) OnMuseMessage() (*types.Transaction, error) {
	return _DappReverter.Contract.OnMuseMessage(&_DappReverter.TransactOpts)
}

// OnMuseMessage is a paid mutator transaction binding the contract method 0x705847b7.
//
// Solidity: function onMuseMessage() returns()
func (_DappReverter *DappReverterTransactorSession) OnMuseMessage() (*types.Transaction, error) {
	return _DappReverter.Contract.OnMuseMessage(&_DappReverter.TransactOpts)
}

// OnMuseRevert is a paid mutator transaction binding the contract method 0x9a190749.
//
// Solidity: function onMuseRevert() returns()
func (_DappReverter *DappReverterTransactor) OnMuseRevert(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _DappReverter.contract.Transact(opts, "onMuseRevert")
}

// OnMuseRevert is a paid mutator transaction binding the contract method 0x9a190749.
//
// Solidity: function onMuseRevert() returns()
func (_DappReverter *DappReverterSession) OnMuseRevert() (*types.Transaction, error) {
	return _DappReverter.Contract.OnMuseRevert(&_DappReverter.TransactOpts)
}

// OnMuseRevert is a paid mutator transaction binding the contract method 0x9a190749.
//
// Solidity: function onMuseRevert() returns()
func (_DappReverter *DappReverterTransactorSession) OnMuseRevert() (*types.Transaction, error) {
	return _DappReverter.Contract.OnMuseRevert(&_DappReverter.TransactOpts)
}
