...
// LegacyDepositERC20 sends ERC20 into MEVM using legacy protocol contracts
...
// LegacyDepositERC20WithAmountAndMessage sends ERC20 into MEVM using legacy protocol contracts
...
// LegacyDepositEther sends Ethers into MEVM using legacy protocol contracts using legacy protocol contracts
...
// LegacyDepositEtherWithAmount sends Ethers into MEVM
func (r *E2ERunner) LegacyDepositEtherWithAmount(amount *big.Int) ethcommon.Hash {
	r.Logger.Print("⏳ depositing Ethers into MEVM")
