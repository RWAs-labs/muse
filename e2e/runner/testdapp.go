...
// AssertTestDAppMEVMCalled is a function that asserts the values of the test dapp on the MEVM
// this function uses TestDAppV2 for the assertions, in the future we should only use this contracts for all tests
// https://github.com/RWAs-labs/muse/issues/2655
func (r *E2ERunner) AssertTestDAppMEVMCalled(expectedCalled bool, message string, amount *big.Int) {
	r.assertTestDAppCalled(r.TestDAppV2MEVM, message, expectedCalled, amount)
}
