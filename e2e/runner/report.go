...
// https://github.com/RWAs-labs/muse/issues/1873
...
func (r *E2ERunner) GenerateNetworkReport() (NetworkReport, error) {
	...
	blockRes, err := r.MEVMClient.BlockNumber(r.Ctx)
	if err != nil {
		return NetworkReport{}, err
	}
...
func (r *E2ERunner) PrintNetworkReport(nr NetworkReport) {
	...
	r.Logger.Print("Emissions Pool Balance: %sMUSE", nr.EmissionsPoolBalance.Quo(sdkmath.NewIntFromUint64(1e18)))
}
